...
export function Ubicacion() {
  return (
    <section id="ubicacion" className="bg-pan-crema-muted/60 px-6 py-24 sm:py-32">
      <div className="mx-auto grid max-w-5xl items-center gap-10 lg:grid-cols-2">
        ...
        >
          <div className="mb-5 flex h-14 w-14 items-center justify-center rounded-2xl bg-pan-terracota-suave/60 text-pan-terracota">
          ...
          <a
            ...
            className="mt-6 inline-flex items-center gap-2 rounded-full border border-pan-bronce-suave bg-pan-crema-suave px-5 py-2.5 text-sm font-semibold text-pan-carbon transition-colors hover:bg-pan-crema"
          >
        ...
        <motion.div
          ...
          className="aspect-4/3 w-full overflow-hidden rounded-3xl shadow-sm shadow-pan-carbon/10"
        >
          <iframe
